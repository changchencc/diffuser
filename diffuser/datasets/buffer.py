...
class OnlineReplayBuffer:
    ...
    def __init__(self, env='maze2d-large-v1', horizon=64,
        ...
        max_n_episodes=10000, termination_penalty=0, use_padding=False, batch_size=32, seed=0):
        self._dict = {
            'path_lengths': np.zeros(max_n_episodes, dtype=np.int),
        }
    ...
    def add_step(self, obs, reward, terminal, info):
        ...
        if use_timeouts:
            ...
            final_timestep = (len(self.on_going['rewards']) == self.env._max_episode_steps - 1)
    ...
    def sample_episodes(self, balance=False):
      ...
      while True:
        ...
        observations = self._dict['normed_observations'][idx, index: index+self.horizon]
